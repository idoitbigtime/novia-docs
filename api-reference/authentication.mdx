...
The Novia AI Call Center API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your Novia AI Call Center account at [https://app.Novia AI Call Center](https://app.Novia AI Call Center)
...
```bash
curl -X GET "https://api.Novia AI Call Center/api/user/campaigns" \
