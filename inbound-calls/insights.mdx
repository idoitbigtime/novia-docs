...
After an inbound call, Novia AI Call Center provides transcripts, analytics, and possible automation triggers.
...
- In your Novia AI Call Center dashboard, go to **Calls** or **History**.
