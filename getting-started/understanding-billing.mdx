...
icon: "credit-card"
description: "Learn how Novia AI Call Center billing works, including call minutes calculation, phone number rentals, and usage monitoring"
---

Novia AI Call Center operates on a **usage-based** model. You pay primarily for two things:
...
- **Per-Second Billing**: Typically, Novia AI Call Center bills by the second (converted to minutes). For example, a 90-second call is 1.5 minutes.
