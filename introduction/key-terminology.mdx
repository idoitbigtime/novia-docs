...
icon: "book"
description: "Essential terms and concepts you need to know to use Novia AI Call Center effectively"
---

Understanding these terms will help you navigate Novia AI Call Center more easily:
...
Novia AI Call Center's built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code.
...
A method to connect your existing phone system or VOIP provider with Novia AI Call Center without renting new numbers.
