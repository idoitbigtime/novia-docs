...
If you want deeper customization beyond no-code blocks, Novia AI Call Center supports **webhooks** and a **REST API**.

## 1. Webhooks

- **When to Use**: Trigger events in external systems the moment something happens in Novia AI Call Center (e.g., "Call Ended,").
...
**Note:** You'll find the official API reference in a dedicated docs section or via your Novia AI Call Center dashboard. Always secure your tokens and test endpoints in a dev environment.
