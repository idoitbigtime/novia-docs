...
description: "Learn about Novia AI Call Center's built-in automation engine for creating workflows without coding"
---
...
Novia AI Call Center includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Novia AI Call Center (e.g., "call ended," "inbound call context injection").
