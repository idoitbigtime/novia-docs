...
icon: "clock"
description: "Learn how flow versioning works in Novia AI Call Center"
---

Novia AI Call Center keeps track of all published flows and their versions. Here’s how it works:
...
4. If you try to edit a published flow, Novia AI Call Center will create a new **draft** if there is none and copy the **published** version to the new version.
