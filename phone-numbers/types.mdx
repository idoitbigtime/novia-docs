...
icon: "phone"
description: "Learn about the different types of phone numbers you can use with Novia AI Call Center: dedicated numbers, SIP integration, and Caller ID"
---

Novia AI Call Center lets you connect three different kinds of phone numbers to your AI assistant:

1. **Normal (Dedicated) Numbers**

   - Rented directly from Novia AI Call Center.
...
2. **SIP Integration (VOIP/PBX)**
   ...
   - This setup allows you to keep your existing numbers while benefiting from Novia AI Call Center's AI.
