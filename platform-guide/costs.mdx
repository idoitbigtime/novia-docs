---
title: Costs
description: "Novia AI Call Center.ai is a pay-as-you-go platform, you only pay for what you use."
---
...
- **Novia AI Call Center costs**: These are the costs associated with the AI assistant handling the call
- **Carrier costs**: These are the costs associated with the carrier (telephone network) used to make the call

## Novia AI Call Center costs
