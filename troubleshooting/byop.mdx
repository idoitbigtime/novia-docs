...
description: "Learn how to use your existing phone numbers or Twilio account with Novia AI Call Center through SIP integration or Caller ID verification"
---
...
- Inbound & outbound will flow through your existing lines, but still utilize Novia AI Call Center's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through Novia AI Call Center or using a custom approach.
